...
public class Inflector {
     ...
     */
    private String lowerCamelCase(String lowerCaseAndUnderscoredWord,
                                  char... delimiterChars) {
     ...
     */
    private String upperCamelCase(String lowerCaseAndUnderscoredWord,
                                  char... delimiterChars) {
     ...
     * @see #lowerCamelCase(String, char[])
     */
    private String camelCase(String lowerCaseAndUnderscoredWord,
     ...
     */
    private String underscore(String camelCaseWord,
                              char... delimiterChars) {
     ...
     */
    private String humanize(String lowerCaseAndUnderscoredWords,
     ...
     */
    private String titleCase(String words,
                             String... removableTokens) {
     ...
     */
    private Set<String> getUncountables() {
        return uncountables;
    }
